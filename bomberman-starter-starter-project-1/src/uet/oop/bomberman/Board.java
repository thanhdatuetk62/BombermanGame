...
public class Board implements IRender
{
    ...
    {
        _game.resetScreenDelay();
        if (_screenToShow <= 0) _screenToShow = 3;
        _game.pause();
    }
    ...
    public boolean detectNoEnemies()
    {
        ...
        for (int i = 0; i < _characters.size(); i++)
        {
            if (_characters.get(i) instanceof Bomber == false) ++total;
        }
    ...
    {
        if (_game.isPaused()) return this._time;
    ...
    private char revive(Entity e)
    {
        ...
        } else if (e instanceof Character)
        {
            ...
            {
                if (getEntity(e.getXTile(), e.getYTile(), (Bomber) e) instanceof Bomb) return '5';
                return 'p';
        ...
        {
            Bomber b = getBomber();
            if (b.getXTile() == e.getX() && b.getYTile() == e.getY()) return '5';
            return '4';
        } else return ' ';
    }
