...
public class Bomb extends AnimatedEntitiy
{
    ...
    public void update()
    {
        if (_timeToExplode > 0) _timeToExplode--;
        else
        {
    ...
    public void render(Screen screen)
    {
        if (_exploded)
        {
            ...
            renderFlames(screen);
        } else _sprite = Sprite.movingSprite(Sprite.bomb, Sprite.bomb_1, Sprite.bomb_2, _animate, 40);
    ...
    public boolean collide(Entity e)
    {
        ...
        if (e instanceof Bomber)
        {
            ...
            if ((tile_LoLx == _x && tile_LoLy == _y) || (tile_LoRx == _x && tile_LoRy == _y) || (tile_UpLx == _x && tile_UpLy == _y) || (tile_UpRx == _x && tile_UpRy == _y))
            {
                return false;
            }
        }
